...
author: "Gwendal Le Bideau, Samira Ait-El-Mkadem - Saadi, Sylvie Bannwarth, Véronique Paquis-Flucklinger, Silvia Bottini"
...
print(head(outliers))
```
It is also possible to get an approximation of the negative binomial P-value using an estimation of the gene dispersion. This will only work if you are using raw counts.
